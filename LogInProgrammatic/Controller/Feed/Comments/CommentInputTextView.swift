...
class CommentInputTextView: UITextView {
    ...
    override init(frame: CGRect, textContainer: NSTextContainer?) {
        ...
        placeholderLabel.anchor(top: nil, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 8, paddingLeft: 6, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
